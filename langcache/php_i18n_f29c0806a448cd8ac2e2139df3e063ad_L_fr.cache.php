...
const title_accueil = 'Accueil - Agence web MboaGeek - Création de sites internet à Douala et dans tout le Cameroun';
const title_erreur404 = 'Erreur 404 - Agence web MboaGeek - Création de sites internet à Douala et dans tout le Cameroun';
const title_apropos = 'A propos - Agence web MboaGeek - Création de sites internet à Douala et dans tout le Cameroun';
const title_services = 'Services - Agence web MboaGeek - Création de sites internet à Douala et dans tout le Cameroun';
const title_galerie = 'Galerie - Agence web MboaGeek - Création de sites internet à Douala et dans tout le Cameroun';
const title_tarifs = 'Tarifs - Agence web MboaGeek - Création de sites internet à Douala et dans tout le Cameroun';
const title_contactus = 'Contactez nous - Agence web MboaGeek - Création de sites internet à Douala et dans tout le Cameroun';
