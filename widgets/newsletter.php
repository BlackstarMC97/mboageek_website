            ...
            <div class="col-sm-12">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-5 control-label pull-left hidden-xs" style="color:white;font-size:1.5em;"><i class="fa fa-envelope"></i> <?php echo L::newsletter_title; ?></label>
                        <label for="inputEmail3" class="col-sm-5 control-label pull-left visible-xs" style="color:white;font-size:1.5em;margin-bottom:5px;"><i class="fa fa-envelope"></i> <?php echo L::notre; ?> NEWSLETTER</label>
