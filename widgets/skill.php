<div class="skill">
    <h2><?php echo L::temoignage_title; ?></h2>
    <p><?php echo L::temoignage_intro; ?></p>
    ...
    <div class="testimonial">
        ...
        <div class="media testimonial-inner">
          ...
          <div class="media-body" style="background-color:white;padding:5px;border-radius:3px;">
              ...
              <span><strong>- <?php echo L::tchotsoua_nom; ?> /</strong> <?php echo L::tchotsoua_fonction; ?></span>
          </div>
        </div>
        ...
        <div class="media testimonial-inner">
          ...
          <div class="media-body" style="background-color:white;padding:5px;border-radius:3px;">
              ...
              <span><strong>- <?php echo L::choake_nom; ?> /</strong> <?php echo L::choake_fonction; ?></span>
          </div>
        </div>
        ...
        <div class="media testimonial-inner">
          ...
          <div class="media-body" style="background-color:white;padding:5px;border-radius:3px;">
              ...
              <span><strong>- <?php echo L::fotsing_nom; ?> /</strong> <?php echo L::fotsing_fonction; ?></span>
          </div>
        </div>
